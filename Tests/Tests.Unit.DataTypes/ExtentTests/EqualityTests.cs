...
namespace Tests.Unit.DataTypes.ExtentTests
{
    ...
    public class EqualityTests : TestBase
    {
        ...
        {
            // arrange
            var range = new Extent<int>(12, 32, RangeInclusion.Inclusive);
        ...
        {
            // arrange
            var range = new Extent<int>(0, 10, RangeInclusion.Inclusive);
        ...
        {
            // arrange
            var range = new Extent<int>(1, 10, RangeInclusion.Inclusive);
        ...
        {
            // arrange
            var lhs = new Extent<DateTime>(GetDate(startDateLhs), GetDate(endDateLhs), inclusionLhs);
            var rhs = new Extent<DateTime>(GetDate(startDateRhs), GetDate(endDateRhs), inclusionRhs);
        ...
        private void RunEqualityTest<T>(Extent<T> lhs, Extent<T> rhs, bool areExpectedToBeEqual) where T: IComparable<T>
        {
            // arrange
